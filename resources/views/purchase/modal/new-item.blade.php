	...
	<div class="modal-dialog modal-dialog-centered modal-sm" role="document">
		<div class="modal-content">
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td class="p-2"><input type="number" id="qty_item" name="qty_item" class="form-control height" autocomplete="off" value="1" min="1" required></td>
                            </tr>
                            <tr>
                                <td class="p-2"><span class="col-form-label-sm text-uppercase display-4">Harga</span></td>
                                <td class="p-2"><input type="number" id="price_item" name="price_item" class="form-control" autocomplete="off" value="0" min="0" required></td>
                            </tr>
                            <tr>
                                <td class="p-2"><span class="col-form-label-sm text-uppercase display-4">Sub Total</span></td>
                                <td class="p-2"><input type="number" id="sub_total_item" name="sub_total_item" class="form-control" autocomplete="off" readonly></td>
                            </tr>
                            <tr>
                                ...
                                <td class="p-2">
                                    <div class="input-group">
                                        ...
                                        <input type="number" id="disc_pctg_item" name="disc_pctg_item" class="form-control" style="width: 50%" autocomplete="off" value="0">
                                    </div>
                                    ...
                                    <div class="input-group mt-2">
                                        ...
                                        <input type="number" id="disc_rp_item" name="disc_rp_item" class="form-control" autocomplete="off" value="0">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="p-2"><span class="col-form-label-sm text-uppercase display-4">Total</span></td>
                                <td class="p-2"><input type="number" id="total_item" name="total_item" class="form-control" autocomplete="off" readonly></td>
                            </tr>
                        </table>
                    </div>
                </div>
            ...
            <div class="modal-footer justify-content-center">
                ...
                <button type="buton" class="btn btn-facebook btn-sm" id="btn_add_item" name="btn_add_item"></button>
            </div>
		</div>
	</div>
</div>
